...
const defaultReviews: Review[] = [
  ...
  name: "Carlos T.",
  role: "Contador",
  text: "Me ayudó a optimizar el sistema contable y mejorar el rendimiento del equipo. Ahora todo funciona mucho más rápido.",
  rating: 4.5,
  likes: 18,
},
{
  name: "Daniela V.",
  role: "Diseñadora",
  text: "Excelente soporte técnico. Solucionó problemas de software que tenía hace semanas en muy poco tiempo.",
  rating: 4,
  likes: 9,
},
{
  name: "Roberto S.",
  role: "Administrador",
  text: "Configuró la red de la oficina y ahora tenemos conexión estable en todos los equipos. Muy recomendable.",
  rating: 5,
  likes: 16,
},
{
  name: "Lucía P.",
  role: "Emprendedora",
  text: "Me asesoró en la compra de equipos y la instalación fue rápida y profesional. Muy satisfecha con el resultado.",
  rating: 4.5,
  likes: 12,
},
{
...
},
{
  name: "Patricia M.",
  role: "Gerente",
  text: "Implementó mejoras en nuestros equipos que redujeron los tiempos de trabajo significativamente.",
  rating: 4,
  likes: 11,
},
{
...
},
{
  ...
  text: "Optimización completa del equipo de trabajo. Ahora los programas cargan mucho más rápido.",
  rating: 4,
  likes: 8,
},
{
  name: "Luis A.",
  role: "Arquitecto",
  text: "Configuró mi estación de trabajo y mejoró el rendimiento en programas pesados.",
  rating: 4.5,
  likes: 13,
},
{
  name: "Marcos D.",
  role: "Programador",
  text: "Excelente asesoría técnica. Me ayudó a mejorar mi entorno de desarrollo.",
  rating: 5,
  likes: 17,
},
{
  name: "Sofía C.",
  role: "Administradora",
  text: "Muy responsable y puntual. Solucionó todos los problemas técnicos.",
  rating: 4,
  likes: 10,
},
{
  name: "Javier L.",
  role: "Empresario",
  text: "Implementó mejoras en la red y seguridad de nuestros sistemas.",
  rating: 4.5,
  likes: 19,
},
{
  name: "Valeria H.",
  role: "Estudiante",
  text: "Me ayudó a recuperar información importante.",
  rating: 4,
  likes: 7,
},
{
  name: "Miguel E.",
  role: "Logística",
  text: "Configuración rápida y eficiente.",
  rating: 4.5,
  likes: 15,
},
  {
